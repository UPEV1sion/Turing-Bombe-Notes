...
\begin{mylisting}
	\inputminted[autogobble]{C}{Implementierung/menu_structs.c}
...
\begin{mylisting}
	\inputminted[autogobble]{C}{Implementierung/terminal.c}
...
\begin{mylisting}
	\inputminted[autogobble, tabsize=4]{C}{Implementierung/diag_method.c}
