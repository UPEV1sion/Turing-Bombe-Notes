...
Da es in Bezug auf die Laufzeit medioker ist, alle 26 Stellen des Bitvektors traversieren zu müssen, um zu überprüfen, welche der 26 Kontakte aktiv ist, wurde ein normaler Vektor eingeführt, der die aktiven Kontakte \glqq dicht\grqq{} speichert.
...
Da es aufgrund der Tupel-Kombinationen nicht genügt, einen Knoten nur einmal zu besuchen, und das Diagonalbrett es unmöglich macht, die Datenstruktur der Knoten linear zur durchlaufen, wird erneut eine \glqq Nachschlagetabelle\grqq{} benötigt.
...
Zuerst werden alle Scrambler-Knoten die mit dem In-Kontakt des Test-Registers verbunden sind in die Warteschlange eingereiht, danach die Commons der jeweiligen Knoten, und als letztes die Knoten, welche an jenen Kontakten anliegen, die durch direkte Permutation der Scrambler oder durch das Diagonalbrett aktiviert wurden.
